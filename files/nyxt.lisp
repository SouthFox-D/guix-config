    "扎咋赃锗奘咋炸扎咋诈乍眨渣札栅轧闸榨喳揸柞楂哳吒铡砟齄咤痄蚱摘债宅窄斋寨翟砦瘵战展站占沾斩辗粘盏崭瞻绽蘸湛詹毡栈谵搌旃长张章丈掌涨帐障账胀仗杖彰璋蟑樟瘴漳嶂鄣獐仉幛嫜着找照招朝赵召罩兆昭肇沼诏钊啁棹笊这着者折哲浙遮辙辄谪蔗蛰褶鹧锗磔摺蜇赭柘真阵镇震针珍圳振诊枕斟贞侦赈甄臻箴疹砧桢缜畛轸胗稹祯浈溱蓁椹榛朕鸩政正证整争征挣郑症睁徵蒸怔筝拯铮峥狰诤鲭钲帧之只知至制直治指支志职致值织纸止质执智置址枝秩植旨滞徵帜稚挚汁掷殖芝吱肢脂峙侄窒蜘趾炙痔咫芷栉枳踯桎帙栀祉轾贽痣豸卮轵埴陟郅黹忮彘骘酯摭絷跖膣雉鸷胝蛭踬祗觯中种重众终钟忠衷肿仲锺踵盅冢忪舯螽周州洲粥舟皱骤轴宙咒昼肘帚胄纣诌绉妯碡啁荮籀繇酎主住注助著逐诸朱驻珠祝猪筑竹煮嘱柱烛铸株瞩蛛伫拄贮洙诛褚铢箸蛀茱炷躅竺杼翥渚潴麈槠橥苎侏瘃疰邾舳抓爪拽嘬传专转赚撰砖篆啭馔颛装状壮庄撞妆幢桩奘僮戆追坠缀锥赘隹椎惴骓缒准谆窀肫着桌捉卓琢灼酌拙浊濯茁啄斫镯涿焯浞倬禚诼擢吱驺赚琢柞嘬唑"
  ...
  "ASCII char to most common simplifed Chinese characters."
  )
...
(defun my/score-suggestion-string (input suggestion-string)
...
A higher score means the SUGGESTION-STRING comes first."
  (let ((i 0) (score 0.0) (lastchar #\ )
    ...
    (labels ((match-bonus (i)
             ...
             (pinyin-match (c)
               (let ((diff (- (char-code c) (char-code #\a))))
                 (loop for x across (nth diff pinyin-table) do
                   (when (position x suggestion-string :start i)
                     (return (position x suggestion-string :start i))))))
             (pinyin-bound ()
               (let ((lastchar-diff (- (char-code lastchar) (char-code #\a))))
                 (match-bonus i)
             ...
             (word-body (c)
               (let ((next (or (position c suggestion-string :start i) 99999))
                     (py-next (or (pinyin-match c) 99999)))
                 (when (and (= next 99999) (= py-next 99999))
                   (return-from word-body))
                 (if (< py-next next)
                     (progn
                       (setf i py-next)
                       (match-bonus py-next)
...
(defun my/pyszm-fuzzy-match (suggestion source input)
  "Score the SUGGESTION according to a fuzzy string distance to the INPUT."
  (setf (prompter:score suggestion)
...
(define-command-global py-follow-hint ()
  ...
  (alexandria:when-let*
   ((buffer (current-buffer))
    (results (prompt :prompt "Interact with element"
                     :extra-modes (list 'nyxt/mode/hint-prompt-buffer:hint-prompt-buffer-mode)
                     :auto-return-p t
                     :history nil

                     :height (if (eq :vi (nyxt/mode/hint:hinting-type (find-submode 'nyxt/mode/hint:hint-mode)))
                            :fit-to-prompt
                            :default)
                     ...
                     (make-instance
                      ...
                      :enable-marks-p t
                      :filter
                      (if (eq :vi (nyxt/mode/hint:hinting-type (find-submode 'nyxt/mode/hint:hint-mode)))
